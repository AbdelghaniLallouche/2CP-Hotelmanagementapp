...
public class ReceptionHomeController implements Initializable {
    ...
    @FXML
    Button btn1,btn3,btn5,btn7,minimizeButton,maximizeButton;
    @FXML
    ...
    void SetManageUsers() throws Exception {
        OnClick(7);
        ShowPage("AccountSettings.fxml",dz,btn7);
    }
    @FXML
    void Cancel(){
        System.exit(0);
    ...
    void ShowPage(String fxml, String variable, Button btn) throws Exception {
        ...
        AccountSettingsControllers controller = loader.getController();
