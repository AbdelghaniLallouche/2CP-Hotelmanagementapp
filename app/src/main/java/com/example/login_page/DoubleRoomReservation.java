...
public class DoubleRoomReservation implements Initializable {
    @FXML
    ...
    void add() throws IOException {
        if(from.getValue() == null || to.getValue() == null || price.getText() == null || name.getText()==null || card.getText() == null || phone.getText() == null || sndname.getText()==null || sndcard.getText() == null || sndphone.getText() == null || price.getText().isEmpty() || name.getText().isEmpty() || card.getText().isEmpty() || phone.getText().isEmpty() || sndname.getText().isEmpty() || sndcard.getText().isEmpty() || sndphone.getText().isEmpty()){
